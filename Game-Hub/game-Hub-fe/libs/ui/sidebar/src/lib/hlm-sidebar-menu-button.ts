...
const sidebarMenuButtonVariants = cva(
  ...
  'data-active:bg-[#26334a] data-active:text-[#4da3ff] ' +
  'data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground gap-2 rounded-[10px] ' +
  '!h-[40px] !min-h-0 !px-4 text-start text-[#aaa] cursor-pointer !transition-all !duration-200 hover:bg-[#26334a] hover:text-[#4da3ff] ' +
  'group-has-data-[sidebar=menu-action]/menu-item:pe-8 group-data-[collapsible=icon]:size-8! ' +
  'group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:!px-1.5 focus-visible:ring-2 data-active:font-medium peer/menu-button ' +
  'group/menu-button flex w-[calc(100%-24px)] !mx-auto items-center group-data-[collapsible=icon]:!mx-auto ' +
  'overflow-hidden outline-hidden disabled:pointer-events-none disabled:opacity-50 ' +
  'aria-disabled:pointer-events-none aria-disabled:opacity-50 ' +
  '[&_ng-icon]:shrink-0 [&_ng-icon]:text-[length:--spacing(4)] [&>span:last-child]:truncate',
	{
		variants: {
			variant: {
