...
export class HlmSwitch implements ControlValueAccessor {
	...
	protected readonly _computedClass = computed(() =>
		hlm(
      'data-checked:bg-[#155dfc] data-unchecked:bg-[#2A3445] ' +
      'data-[matches-spartan-invalid=true]:ring-destructive/20 ' +
      'dark:data-[matches-spartan-invalid=true]:ring-destructive/40 ' +
      'data-[matches-spartan-invalid=true]:border-destructive ' +
      'dark:data-[matches-spartan-invalid=true]:border-destructive/50 ' +
      'dark:data-unchecked:bg-[#2A3445] rounded-full border border-transparent ' +
      'data-[matches-spartan-invalid=true]:ring-3 ' +
      'data-[size=default]:h-[18.4px] data-[size=default]:w-[32px] ' +
      'data-[size=sm]:h-[14px] data-[size=sm]:w-[24px] ' +
      'group/switch inline-flex shrink-0 items-center transition-all ' +
      'outline-none data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-50',
			this.userClass(),
		),
	);
