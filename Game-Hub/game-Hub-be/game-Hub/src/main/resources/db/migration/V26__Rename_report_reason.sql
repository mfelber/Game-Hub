...
TRUNCATE TABLE
  game_hub.report,
    game_hub.community_guidelines,
  game_hub.ban_history
RESTART IDENTITY;
...
VALUES ('Inappropriate behavior / language', 'Offensive, disrespectful, or abusive behavior was detected.'),
       ...
       ('Hate speech / Discrimination','Content promotes hatred, discrimination, or hostility toward a person or group.'),
       ...
       ('Malicious links / Malware','Suspicious links, malicious software, or potentially harmful content was shared.'),
